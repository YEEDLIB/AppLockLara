package com.applocklara.applocklara.shizuku
...
import com.applocklara.applocklara.core.broadcast.DeviceUnlockReceiver
...
import com.applocklara.applocklara.services.isDeviceLocked
...
class ShizukuActivityManager(
    ...
    private fun checkForegroundApp() {
        ...
        getTasksWrapper().filterVisible().forEach {
            ...
            // then trigger App Lock Lara for any new foreground app
            ...
            if (packageName != lastForegroundApp) {
                ...
                if (lastForegroundApp in triggerExclusions) {
                    LogUtils.d(
                        TAG,
                        "Previous app $lastForegroundApp is excluded, skipping App Lock Lara for $packageName"
                    )
                    lastForegroundApp = packageName
                    return
                }
