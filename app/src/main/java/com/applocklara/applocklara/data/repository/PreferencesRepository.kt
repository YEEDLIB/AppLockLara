package com.applocklara.applocklara.data.repository
...
class PreferencesRepository(context: Context) {
    ...
    fun setPassword(password: String) {
        ...
        settingsPrefs.edit(commit = true) { putInt("password_length", password.length) }
    }

    fun getPasswordLength(): Int {
        return settingsPrefs.getInt("password_length", 4)
    }
    ...
    fun getIntruderAttemptLimit(): Int {
        return settingsPrefs.getInt(KEY_INTRUDER_ATTEMPT_LIMIT, 3)
    }

    fun setIntruderAttemptLimit(limit: Int) {
        settingsPrefs.edit { putInt(KEY_INTRUDER_ATTEMPT_LIMIT, limit.coerceIn(1, 7)) }
    }
    ...
    companion object {
        ...
        private const val KEY_INTRUDER_ATTEMPT_LIMIT = "intruder_attempt_limit"
