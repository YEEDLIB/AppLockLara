...
import com.applocklara.applocklara.data.manager.BackendServiceManager
 ...
 * Provides a unified interface for all App Lock Lara functionality.
 */
class AppLockRepository(private val context: Context) {
    ...
    fun getIntruderAttemptLimit(): Int = preferencesRepository.getIntruderAttemptLimit()
    fun setIntruderAttemptLimit(limit: Int) = preferencesRepository.setIntruderAttemptLimit(limit)
