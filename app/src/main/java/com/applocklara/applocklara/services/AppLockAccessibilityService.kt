package com.applocklara.applocklara.services
...
import com.applocklara.applocklara.core.utils.enableAccessibilityServiceWithShizuku
...
import com.applocklara.applocklara.features.lockscreen.ui.LockScreenOverlayManager
import com.applocklara.applocklara.services.AppLockConstants.ACCESSIBILITY_SETTINGS_CLASSES
import com.applocklara.applocklara.services.AppLockConstants.EXCLUDED_APPS
...
class AppLockAccessibilityService : AccessibilityService() {
    ...
    companion object {
        ...
        private const val APP_PACKAGE_PREFIX = "com.applocklara.applocklara"
    ...
    private fun checkForDeviceAdminDeactivation(event: AccessibilityEvent) {
        ...
        //val isOurAppVisible = findNodeWithTextContaining(rootNode, "App Lock Lara") != null ||
    ...
    private fun isDeactivationAttempt(event: AccessibilityEvent): Boolean {
        val isAccessibilitySettings = event.className in ACCESSIBILITY_SETTINGS_CLASSES &&
                event.text.any { it.contains("App Lock Lara") }
        ...
        val isAlertDialog =
            event.packageName == "com.google.android.packageinstaller" && event.className == "android.app.AlertDialog" && event.text.toString()
                .lowercase().contains("App Lock Lara")
